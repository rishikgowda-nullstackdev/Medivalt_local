...
-- =========================================================================
-- PATIENT PORTAL: User Accounts & Dietary/Wellness Recommendations
-- =========================================================================

-- 17. Patient Portal User Accounts (Separate from Practitioner Auth)
...
-- 18. Condition-Based Dietary Guidelines (Deterministic Fallback for LLM)
...
-- Seed Dietary Guidelines: Chronic Kidney Disease
INSERT OR IGNORE INTO dietary_guidelines (condition_keyword, category, item, rationale) VALUES
...
-- Seed Dietary Guidelines: Diabetes
INSERT OR IGNORE INTO dietary_guidelines (condition_keyword, category, item, rationale) VALUES
...
-- Seed Dietary Guidelines: Hypertension
INSERT OR IGNORE INTO dietary_guidelines (condition_keyword, category, item, rationale) VALUES
...
-- Seed Dietary Guidelines: Asthma
INSERT OR IGNORE INTO dietary_guidelines (condition_keyword, category, item, rationale) VALUES
...
-- Seed Dietary Guidelines: Atrial Fibrillation / Anticoagulation
INSERT OR IGNORE INTO dietary_guidelines (condition_keyword, category, item, rationale) VALUES
